...
describe('Destructuring', () => {
  ...
  describe('with Objects', () => {
    ...
    it('can alias destructured variables', () => {
      ...
      //and pull the city, state and zip out, and alias them to c, s, z, respectively
    ...
    it('can destructure nested variables', () => {
      ...
      // Using destructuring, call `getAddress()`
      //and create an pull out the nested 'lat' and 'long' variables
  ...
  describe('with Arrays', ()=> {
    ...
    it('can be used to pull apart arrays', () => {
      ...
      // Call getNumbers and pull the first value out as `one`
      //and the second as `two`
    ...
    it('can skip indexes in arrays', () => {
      ...
      // Call getNumbers and pull the first value out as `one`
      //and the third as `three`. Don't pull out the second index. Skip it
    ...
    it('can reach nested arrays', () => {
      ...
      // Call getNestedNumbers and pull 1 out as `one`,
