...
describe(`Spread`, () => {
  ...
  it`should be easier to concatenate arrays`, () => {
    const array1 = [1, 2, 3]
    // create a result array that uses the spread operator
    //to concatenate array1 with [4, 5, 6]
  ...
  it(`should be able to merge properties from objects`, () => {
    ...
    // create a result object that uses the spread operator
    //to add `eggs: 'spam'` to what exists in obj1
    const result = {
      ...obj1,
      eggs: 'spam',
    }
