...
describe(`String`, () => {
  it(`should be easier to determine whether a string includes another`, () => {
    ...
    //that is assigned to a call of sentence.includes
    const result = sentence.includes('was the best')
...
describe(`Array`, () => {
  ...
  it(`should be easier to fill an array with values`, () => {
    ...
    // create a variable called `result`
    //and assign it to an array that's filled with 3s except for the first item.
